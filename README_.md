...
flowchart LR
    ...
    APP --> ML["LSTM model<br/>identity verification"]
...
a fixed 250 Hz using a hardware timer → host application → LSTM inference.
...
**Model (Python / TensorFlow)** — LSTM over segmented, filtered ECG. Evaluation uses
...
- [x] LSTM training pipeline and evaluation
